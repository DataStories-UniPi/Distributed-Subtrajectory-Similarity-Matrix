 ...
 */
public class BloatFileSplit extends InputSplit implements Writable {
   ...
   * default constructor
   */
  public BloatFileSplit() {}
  public BloatFileSplit(Path[] files, long[] start, 
  ...
  public BloatFileSplit(Path[] files, long[] lengths) {
   ...
   * Copy constructor
   */
  public BloatFileSplit(BloatFileSplit old) throws IOException {

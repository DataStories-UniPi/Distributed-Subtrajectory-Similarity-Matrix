 ...
 */
public class KeyValueIntWritableInputFormat extends FileInputFormat<IntWritable, Text> {
  ...
  public RecordReader<IntWritable, Text> createRecordReader(InputSplit genericSplit,
    ...
    return new KeyValueIntWritableRecordReader(context.getConfiguration());
  }

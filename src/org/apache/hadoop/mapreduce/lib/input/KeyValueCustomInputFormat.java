 ...
 */
public class KeyValueCustomInputFormat extends FileInputFormat<DTJrPairElement, Text> {
  ...
  public RecordReader<DTJrPairElement, Text> createRecordReader(InputSplit genericSplit,
      TaskAttemptContext context) throws IOException {
    
    context.setStatus(genericSplit.toString());
    return new KeyValueCustomRecordReader(context.getConfiguration());
  }

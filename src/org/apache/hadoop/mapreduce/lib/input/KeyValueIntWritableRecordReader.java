 ...
 */
public class KeyValueIntWritableRecordReader extends RecordReader<IntWritable, Text> {
  ...
  public KeyValueIntWritableRecordReader(Configuration conf)
    throws IOException {
  ...
  public static void setKeyValue(IntWritable key, Text value, byte[] line,
    ...
    if (pos == -1) {
      ...
      int key_line = Integer.parseInt(temp_key.toString());
      key.set(key_line);
      value.set("");

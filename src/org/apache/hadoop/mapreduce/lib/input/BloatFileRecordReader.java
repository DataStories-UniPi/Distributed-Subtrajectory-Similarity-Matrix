...
public class BloatFileRecordReader<K, V> extends RecordReader<K, V> {

  @SuppressWarnings("rawtypes")
static final Class [] constructorSignature = new Class [] 
                                         {BloatFileSplit.class,
                                          TaskAttemptContext.class,
                                          Integer.class};

  protected BloatFileSplit split;
  ...
  public void initialize(InputSplit split,
    ...
    this.split = (BloatFileSplit)split;
   ...
   */
  public BloatFileRecordReader(BloatFileSplit split,

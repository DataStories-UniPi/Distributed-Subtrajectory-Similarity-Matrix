...
public class DTJSubtrajPointPair implements Writable, WritableComparable<DTJSubtrajPointPair> {
	...
	public DTJSubtrajPointPair() {
		
	}
	public DTJSubtrajPointPair(DTJSubtrajPointPair elem) {
	...
	public DTJSubtrajPointPair(int r_obj_id, int r_traj_id, int r_subtraj_id, int s_obj_id, int s_traj_id) {
	...
	public String toString() {
		...
		return (new StringBuilder().append(r_obj_id).append(",").append(r_traj_id).append(",").append(r_subtraj_id).append(",").append(s_obj_id).append(",").append(s_traj_id).toString());
	}
	...
	public void write(DataOutput dataOutput) throws IOException {
	 ...
	 @Override
	    public boolean equals(Object o) {
	        ...
	        if (!(o instanceof DTJSubtrajPointPair)) {
	            return false;
	        }

	        DTJSubtrajPointPair pair = (DTJSubtrajPointPair) o;

	        return pair.r_obj_id == r_obj_id && pair.r_traj_id == r_traj_id && pair.r_subtraj_id == r_subtraj_id && pair.s_obj_id == s_obj_id && pair.s_traj_id == s_traj_id;
	    }
	...
	public int compareTo(DTJSubtrajPointPair objKeyPair) {
